...
export const Header: React.FC<HeaderProps> = ({
  ...
  const [openDropdown, setOpenDropdown] = useState<'templates' | 'quickAdd' | 'export' | 'mobileMenu' | null>(null);
  ...
  const toggleDropdown = (key: 'templates' | 'quickAdd' | 'export' | 'mobileMenu') => {
  ...
  return (
    <header
      ...
      ref={dropdownRef}
      className="shrink-0 w-full z-40 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 transition-colors"
    >
      <div
        id="app-header-bar"
        className="h-12 px-2 sm:px-3.5 flex items-center justify-between gap-1.5 sm:gap-3 text-slate-800 dark:text-slate-200"
      >
        {/* Left Section: Brand & Title */}
        <div className="flex items-center gap-2 sm:gap-2.5 min-w-0 shrink">
          <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 rounded flex items-center justify-center text-white font-bold text-xs tracking-tight shadow-xs shrink-0">
            ZD
          </div>
          <div className="flex flex-col min-w-0">
            {isEditingTitle ? (
              <div className="flex items-center gap-1">
                <input
                  ...
                  className="px-1.5 py-0.5 text-xs font-bold bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded focus:outline-hidden focus:ring-1 focus:ring-blue-500 w-28 xs:w-36 sm:w-48 text-slate-900 dark:text-slate-100"
                  maxLength={60}
                />
                <button
              ...
              <button
                ...
                className="group flex items-center gap-1 text-left px-1 py-0.5 rounded hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors truncate max-w-[100px] xs:max-w-[130px] sm:max-w-[190px] md:max-w-[260px]"
            ...
            <span className="text-[9px] sm:text-[10px] text-slate-400 dark:text-slate-500 leading-none truncate hidden xs:inline">
              Auto-saved
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-1.5">
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1 px-2 sm:px-2.5 py-1 text-xs font-medium rounded border transition-colors ${
              ...
              title="Canvas Starter Templates"
            >
            ...
            {openDropdown === 'templates' && (
              <div
                ...
                className="fixed sm:absolute left-2 right-2 sm:left-0 sm:right-auto top-14 sm:top-full mt-1 sm:w-72 max-w-[calc(100vw-1rem)] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded shadow-xl py-1 z-50 animate-in fade-in zoom-in-95 duration-150"
              >
                ...
                <div className="py-1 max-h-[60vh] sm:max-h-80 overflow-y-auto">
          ...
          <div className="relative">
            <button
              ...
              title="Quick Insert Shapes & Sticky Notes"
            >
            ...
            {openDropdown === 'quickAdd' && (
              <div
                ...
                className="fixed sm:absolute left-2 right-2 sm:left-0 sm:right-auto top-14 sm:top-full mt-1 sm:w-64 max-w-[calc(100vw-1rem)] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded shadow-xl p-2.5 z-50 animate-in fade-in zoom-in-95 duration-150"
              >
                {/* Sticky Notes */}
          ...
          {/* Quick Zoom & Fit Controls (Desktop/Tablet) */}
          <div className="hidden md:flex items-center gap-0.5 bg-slate-100 dark:bg-slate-800 p-0.5 rounded">
            <button
              id="zoom-out-btn"
        ...
        {/* Right Section: View toggles, Export, & Mobile Menu */}
        <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
          {/* Grid Toggle (Desktop) */}
          <button
            id="toggle-grid-btn"
            onClick={onToggleGridMode}
            className={`hidden md:flex p-1.5 rounded border text-xs font-medium transition-colors ${
              isGridMode
                ? 'bg-blue-50 dark:bg-slate-800 border-blue-500 text-blue-700 dark:text-blue-400'
          ...
          <button
            ...
            className="p-1.5 rounded border bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 transition-colors shrink-0"
          ...
          <div className="relative shrink-0">
            <button
              ...
              className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1.5 text-xs font-medium rounded bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-xs"
            >
            ...
            {openDropdown === 'export' && (
              <div
                ...
                className="fixed sm:absolute right-2 sm:right-0 top-14 sm:top-full mt-1 w-56 max-w-[calc(100vw-1rem)] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded shadow-xl py-1 z-50 animate-in fade-in zoom-in-95 duration-150"
              >
                <div className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 border-b border-slate-100 dark:border-slate-800">
                  Export Canvas
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-slate-400">Crisp raster image</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold">Copy PNG to Clipboard</div>
                    <div className="text-[10px] text-slate-400">Paste into any app</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold">Save Backup (.json)</div>
                    <div className="text-[10px] text-slate-400">Complete board archive</div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-slate-400">Load from .json or .tldr</div>
                  </div>
                </button>
          ...
          {/* Clear Canvas (Desktop/Tablet) */}
          <button
            id="clear-canvas-trigger"
            onClick={onOpenClearModal}
            className="hidden sm:flex p-1.5 rounded border bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-red-50 dark:hover:bg-red-950/40 text-slate-500 hover:text-red-600 dark:text-slate-400 dark:hover:text-red-400 transition-colors"
            title="Clear Canvas"
          >
            <Trash2 className="w-3.5 h-3.5" />
          </button>

          {/* Shortcuts Guide (Desktop/Tablet) */}
          <button
            id="shortcuts-modal-trigger"
            onClick={onOpenShortcuts}
            className="hidden sm:flex p-1.5 rounded border bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 transition-colors"
            title="Shortcuts & Gestures Guide"
          >
            <HelpCircle className="w-3.5 h-3.5" />
          </button>

          {/* Zen / Fullscreen Toggle (Desktop/Tablet) */}
          <button
          ...
          {/* Mobile More Actions Menu (Phone screens) */}
          <div className="relative sm:hidden">
            <button
              id="mobile-more-dropdown-trigger"
            ...
            {openDropdown === 'mobileMenu' && (
              <div
                id="mobile-more-menu"
                className="fixed right-2 top-14 mt-1 w-56 max-w-[calc(100vw-1rem)] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded shadow-xl py-1 z-50 animate-in fade-in zoom-in-95 duration-150"
              >
                <div className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 border-b border-slate-100 dark:border-slate-800">
                  Canvas View & Tools
                </div>
                ...
                <div className="px-3 py-2 flex items-center justify-between border-b border-slate-100 dark:border-slate-800">
                  <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">Zoom</span>
                  <div className="flex items-center gap-1">
                    <button
                      id="mobile-zoom-out"
                      onClick={() => editor?.zoomOut()}
                    ...
                    <button
                      id="mobile-zoom-fit"
                      onClick={() => editor?.zoomToFit({ animation: { duration: 300 } })}
                      className="px-2 py-1 text-[10px] font-semibold rounded bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200"
                      title="Fit View"
                    >
                      Fit
                    </button>
                ...
                <button
                  id="mobile-toggle-grid-btn"
                  onClick={() => {
                    onToggleGridMode();
                    setOpenDropdown(null);
                  }}
                  className="w-full text-left px-3 py-2 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center justify-between text-xs text-slate-700 dark:text-slate-200"
                >
                ...
                <button
                  id="mobile-toggle-zen-btn"
                  onClick={() => {
                    onToggleZenMode();
                    setOpenDropdown(null);
                  }}
                  className="w-full text-left px-3 py-2 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2 text-xs text-slate-700 dark:text-slate-200"
                >
                ...
                <button
                  id="mobile-clear-canvas-trigger"
                  onClick={() => {
                    onOpenClearModal();
                    setOpenDropdown(null);
                  }}
                  className="w-full text-left px-3 py-2 hover:bg-red-50 dark:hover:bg-red-950/40 flex items-center gap-2 text-xs text-red-600 dark:text-red-400"
                >
